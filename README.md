...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/seqdat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14571&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/seqdat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `seqdat` can be installed with:

```
conda install seqdat
```

It is possible to list all of the versions of `seqdat` available on your platform with:
